...
export default function Analytics() {
  ...
  const [weeklyThreatsRes, setWeeklyThreatsData] = useState([]);
...
const styles = StyleSheet.create({
  ...
  contentWrapper: {
    flex: 1,
    justifyContent: "space-between", // Or "space-between", "center", based on your UI goals
    alignItems: "stretch", // Makes children use full width
  },
